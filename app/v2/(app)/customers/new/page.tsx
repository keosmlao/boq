...
export default function NewCustomerPage() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res?.success) router.push(editCode ? "/v2/customers" : `/v2/customers/${encodeURIComponent(res.data.code)}`);
    ...
    <Page max="max-w-none">
      ...
      <form onSubmit={submit}>
        ...
        <div className="mt-4 flex justify-end gap-2">
          <Btn type="button" variant="outline" onClick={() => router.push("/v2/customers")}>ຍົກເລີກ</Btn>
