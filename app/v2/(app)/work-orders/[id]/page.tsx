  ...
  return (
    <Page max="max-w-none">
      <div className="mb-3 flex items-center justify-between gap-2">
        <button
          onClick={() => router.push("/v2/work-orders")}
        ...
        {w.src !== "erp" && (
          <DocActions onDelete={() => deleteWorkOrder(String(id))} afterDelete="/v2/work-orders" label="ໃບງານ" />
        )}
      </div>
          ...
          <Card className="overflow-hidden border-t-4 border-t-cyan-500 shadow-sm">
            <div className="flex items-center justify-between border-b border-[var(--theme-border-subtle)] px-4 py-3 bg-slate-50/50">
              ...
              {w.src !== "erp" && w.project_id && mats.length > 0 && (
                <button
                  onClick={() => router.push(`/v2/projects/${w.project_id}/request/new?wo=${id}`)}
        ...
        <div className="space-y-6">
          ...
          <Card className="p-4 shadow-sm bg-slate-50/50">
            <div className="flex flex-col gap-2.5">
              {w.project_id && (
                <button
                  onClick={() => router.push(`/v2/projects/${w.project_id}`)}
