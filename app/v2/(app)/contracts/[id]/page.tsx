  ...
  return (
    <Page max="max-w-none">
      <div className="mb-4 flex items-center justify-between gap-2">
        <button
          onClick={() => router.push("/v2/contracts")}
        ...
        {c.src === "erp" ? (
          <DocActions
            ...
            afterDelete="/v2/contracts"
            label="ສັນຍາ"
          />
        ) : (
          <DocActions
            editHref={c.project_id ? `/v2/projects/${c.project_id}/contract/new?edit=${id}` : undefined}
      ...
      {c.project_id && (
        <div className="mt-4">
          <Btn variant="outline" onClick={() => router.push(`/v2/projects/${c.project_id}`)}>
