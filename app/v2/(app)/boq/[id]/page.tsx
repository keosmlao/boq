    ...
    <Page max="max-w-none">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-700 via-blue-600 to-blue-500 p-5 text-white shadow-[var(--theme-shadow-lg)] mb-6">
        ...
        <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2.5 self-end sm:self-center">
            <DocActions
              editHref={b.project_id ? `/v2/projects/${b.project_id}/boq/new?edit=${encodeURIComponent(b.boq_no)}` : undefined}
      ...
      {b.project_id && (
        <div className="mt-6 flex justify-start">
          <button
            onClick={() => router.push(`/v2/projects/${b.project_id}`)}
