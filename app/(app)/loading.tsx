      ...
      <div className="mx-auto max-w-[1200px] animate-pulse">
        ...
        <div className="mb-6 grid grid-cols-2 gap-3 sm:grid-cols-4">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="flex items-center gap-3.5 rounded-lg border border-[var(--border)] bg-[var(--surface)] p-4">
              <div className="h-11 w-11 flex-shrink-0 rounded-lg bg-[var(--surface-sunken)]" />
        ...
        <div className="overflow-hidden rounded-lg border border-[var(--border)] bg-[var(--surface)]">
          {Array.from({ length: 7 }).map((_, i) => (
            <div key={i} className="flex items-center gap-4 border-b border-[var(--border-soft)] px-4 py-3.5 last:border-b-0">
              <div className="h-9 w-9 flex-shrink-0 rounded-lg bg-[var(--surface-sunken)]" />
              <div className="min-w-0 flex-1">
