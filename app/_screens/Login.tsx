...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      setError("ຊື່ຜູ້ໃຊ້ ຫຼື ລະຫັດຜ່ານ ບໍ່ຖືກຕ້ອງ");
      setLoading(false);
    }
  };
  ...
  const finalizeLogin = (selectedRole, userData = tempUserData) => {
    ...
    switch (selectedRole) {
      case "sale_admin": case "sale_manager": router.push("/sale-admin/listproject"); break;
      case "service_admin": case "service_manager": router.push("/service-admin/listproject"); break;
