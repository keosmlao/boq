// src/pages/project/ProjectListClose.jsx
"use client";
...
const ProjectListClose = () => {
  ...
  const fetchData = useCallback(async () => {
    setLoading(true);
    try {
      const resp = await fetch("/api/projectsboqclose", { headers: _getAuthHeaders() }).then(r => r.json());
...
export default ProjectListClose;
