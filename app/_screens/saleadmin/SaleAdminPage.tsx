  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        const [projectsRes, revenueRes, salesRes] = await Promise.all([
          fetch("/api/projects/dashboard-stats", { headers: _getAuthHeaders() }).then(r => r.json()),
          fetch("/api/projects/revenue-stats", { headers: _getAuthHeaders() }).then(r => r.json()),
          fetch("/api/sales/stats", { headers: _getAuthHeaders() }).then(r => r.json()),
        ]);
        setDashboardData({
