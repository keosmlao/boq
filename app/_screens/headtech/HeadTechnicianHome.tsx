...
const cards = [
  {
    ...
    to: "/service-admin/listproject",
    icon: CalendarClock,
  },
  {
    title: "BOQ",
    desc: "ລາຍການ BOQ ແລະ ສະຕັອກ",
    to: "/service-admin/listboq",
    icon: FileText,
  },
  {
    title: "ໃບຂໍເບີກ",
    desc: "ຄຳຂໍອາໄຫຼ່ປະຈຳວຽກ",
    to: "/service-admin/listrequest",
    icon: Briefcase,
  },
  {
    title: "ຂໍຄືນອາໄຫຼ່",
  ...
  },
  {
    ...
    to: "/service-admin/listsparepart",
    icon: LayoutGrid,
  },
  {
    title: "ບິນງານຊ່າງ",
...
export default function HeadTechnicianHome() {
  return (
