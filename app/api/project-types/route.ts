import { getProjectTypes } from "@/_actions/lookups";
...
export async function GET(request: Request) {
  try {
    ...
    const result = await getProjectTypes({
      ...
      businessModel: searchParams.get("businessModel") || undefined,
    });
    ...
    return serverError(error, "Failed to load project types");
  }
}
